<!--
 * @Author: changcheng
 * @LastEditTime: 2023-10-10 23:12:18
-->

## scheduleCallBack

<img src="../img/scheduleCallback.jpg">


定义5种不同的优先级,来自 `SchedulerPriorities.js`
...
通过`Scheduler_scheduleCallback`执行`performConcurrentWorkOnRoot`,进行时间片调度
